...
export default function Footer() {
    return (
        <div className="p-4 ">
            <h4 className="text-sm my-3">&copy;Copyright 2025 Sung Min Sim. <br/>Select visuals are externally sourced and used for non-commercial portfolio display. Project screenshots are pending permission from respective professors.</h4>
